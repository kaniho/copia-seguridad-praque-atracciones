					...
					<div class="aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<!--Sección de Reseñas-->
								<div class="menu-item">
									<a class="menu-link active" href="<?= base_url("atracciones")?>">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/art/art002.svg-->
											...
											<div class="menu-item me-lg-1">
												...
												<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack"><!-- migas de pan -->
													...
													<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
														<!--begin::Title-->
														<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Atracciones</h1>
														<!--end::Title-->
														<!--begin::Separator-->
														...
														<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
															...
															<!--end::Item-->
															<!--begin::Item-->
															<li class="breadcrumb-item text-dark">Listado de Atracciones</li>
															<!--end::Item-->
														</ul>
														<!--end::Breadcrumb-->
													</div>
							...
							<div id="kt_content_container" class="container-xxl">
								...
								<div class="card">
									...
									<div class="card-header border-0 pt-6">
										...
										<h1 class="text-center">Listado de Atracciones</h1>
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
													...
													<div class="px-7 py-5" data-kt-user-table-filter="form">
														...
														<form method="GET" action="<?= base_url("atracciones") ?>">
															...
															<div class="d-flex justify-content-end">
																<button type="reset" class="btn btn-light btn-active-light-primary fw-bold me-2 px-6" onclick="window.location.href='<?= base_url('atracciones') ?>'">Restablecer</button>
																<button type="submit" class="btn btn-primary">Buscar</button>
															</div>
															<!--end::Actions-->
														</form>
												...
												<!--end::Filter-->
												<!--begin::Export-->
												<form method="GET" action="<?= base_url('atracciones/exportExcel') ?>">
													<input type="hidden" name="nombre" value="<?= esc($nombre) ?>">
													<input type="hidden" name="descripcion" value="<?= esc($descripcion) ?>">
													<input type="hidden" name="altura_minima" value="<?= esc($altura_minima) ?>">
													<input type="hidden" name="capacidad_maxima" value="<?= esc($capacidad_maxima) ?>">
													<input type="hidden" name="estado" value="<?= esc($estado) ?>">														
													<input type="hidden" name="atraccionArchivada" value="<?= esc($atraccionArchivada) ?>">
												...
												<!--begin::Add user-->
												<?php if ($session->get('id_rol') == 1): ?>
												<a href="<?= base_url('atracciones/save') ?>" class="btn btn-primary ">
													<span class="svg-icon svg-icon-2">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
									...
									<div class="card-body pt-0">
										<div id="kt_table_users_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
											<div class="table-responsive">
												<?php if (!empty($atracciones) && is_array($atracciones)): ?>
													<!--begin::Table-->
															...
															<?php foreach ($atracciones as $atraccion): ?>
																<tr> <!-- PRUEBA -->
																	...
																	<td class="position-relative">
																		...
																		<?php endif; ?>
																		<?= esc($atraccion['nombre']) ?> <!-- PARTE DEL FOREACH DONDE PILLA EL NOMBRE -->																		
																	</td>
																	<!--end::User=-->
																	<!--begin::Role=-->
																	<td> <!-- PARTE DEL FOREACH DONDE PILLA LA DESCRIPCIÓN -->
																	<?php
																		$descripcion = htmlspecialchars($atraccion['descripcion']);
																		$maxLength = 49; // Número máximo de caracteres antes de truncar
																		if (strlen($descripcion) > $maxLength) {
																			$truncated = substr($descripcion, 0, $maxLength) . '...';
																			echo '<span title="' . $descripcion . '" data-bs-toggle="tooltip" data-bs-placement="top">' . $truncated . '</span>';
																		} else {
																			echo $descripcion;
																		}
																	?>
																	...
																	<!--begin::Two step=-->
																	<td>
																		<?= esc($atraccion['altura_minima']) ?> <!-- PARTE DEL FOREACH DONDE PILLA LA ALTURA MAXIMA -->
																	</td>
																	<!--end::Two step=-->
																	<!--begin::Joined-->
																	<td>
																		<?= esc($atraccion['capacidad_maxima']) ?> <!-- PARTE DEL FOREACH DONDE PILLA LA CAPACIDAD MAXIMA -->
																	</td> 

																	<td>
																		<?= esc($atraccion['estado']) ?> <!-- PARTE DEL FOREACH DONDE PILLA LOS ESTADOS -->
																	</td> 
																	...
																	<?php if ($session->get('id_rol') == 1): ?>
																		<td class="text-end">
																			...
																			<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																				...
																				<?php if (!$atraccion['archivado']): ?>
																					<div class="menu-item px-3">
																						<a href="<?= base_url('atracciones/save/' . $atraccion['id']) ?>" class="menu-link px-3">
																							Editar<i class="fa-regular fa-pen-to-square ms-4"></i>
																						</a>  <!-- AQUI PONEMOS EL LINK PARA EDITAR LA ATRACCIÓN -->
																					</div>
																				<?php endif; ?>
																				<!--end::Menu item-->
																				<!--begin::Menu item-->
												...
												<?php else: ?>
													<p class="text-center">No hay atracciones registradas.</p>
												<?php endif; ?>
											</div>
										</div>
									</div>								
