											...
											<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack"><!-- migas de pan -->
												...
												<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
													...
													<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
														...
														<!--end::Item-->
														<!--begin::Item-->
														<li class="breadcrumb-item text-dark"><?= isset($atraccion) ? 'Editar Atracción' : 'Crear Atracción' ?></li>
														<!--end::Item-->
													</ul>
													<!--end::Breadcrumb-->
												</div>
						...
						<div id="kt_content_container" class="container-xxl">
							...
							<div class="card mb-5 mb-xl-10"><!-- PARTE DEL FORMULARIO PARA CREAR Y EDITAR -->
                                ...
                                <div id="kt_account_profile_details" class="collapse show">
									...
									<?php endif; ?>
                                    <!--begin::Form-->
                                    <form id="userForm" action="<?= base_url('atracciones/save' . (isset($atraccion['id']) ? '/' . $atraccion['id'] : '')) ?>" method="post">
										<?= csrf_field(); ?>
                                        <!--begin::Card body-->
                                        <div class="card-body border-top p-9">                                       
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label required fw-bold fs-6" for="nombre">Nombre</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <!--begin::Row-->
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label required fw-bold fs-6" for="descripcion">Descripción</label>
                                                <!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
													<textarea name="descripcion" id="descripcion" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Descripción"  maxlength="350" required><?= isset($atraccion['descripcion']) ? esc($atraccion['descripcion']) : '' ?></textarea>
												</div>
												<!--end::Col-->                                                        							
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label required fw-bold fs-6" for="altura_minima">Altura Mínima</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <!--begin::Row-->
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label required fw-bold fs-6" for="capacidad_maxima">Capacidad Máxima</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <!--begin::Row-->
											...
											<div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
													<select class="form-select form-select-lg form-select-solid" name="estado" id="estado" data-control="select2" data-placeholder="Selecciona un estado" required>
														<option></option>
                                        ...
                                        <div class="card-footer d-flex justify-content-end py-6 px-9">
											<a href="<?= base_url('atracciones') ?>" class="btn btn-light btn-active-light-primary me-2">Cancelar</a>
