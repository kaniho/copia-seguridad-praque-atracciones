											...
											<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack"><!-- migas de pan -->
												...
												<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
													...
													<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
														...
														<!--end::Item-->
														<!--begin::Item-->
														<li class="breadcrumb-item text-dark"><?= isset($reserva) ? 'Editar Reserva' : 'Crear Reserva' ?></li>
														<!--end::Item-->
													</ul>
													<!--end::Breadcrumb-->
												</div>
						...
						<div id="kt_content_container" class="container-xxl">
							...
							<div class="card mb-5 mb-xl-10"><!-- PARTE DEL FORMULARIO PARA CREAR Y EDITAR -->
                                ...
                                <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
									...
									<h1 class="text-center"><?= isset($user) ? 'Editar Reserva' : 'Crear Reserva' ?></h1>
                                    </div>
                                    <!--end::Card title-->
                                </div>
                                <!--begin::Card header-->
                                ...
                                <div id="kt_account_profile_details" class="collapse show">
									...
									<?php endif; ?>
                                    <!--begin::Form-->
                                    <form id="userForm" action="<?= isset($reserva) ? base_url('reservas/save/') . $reserva['id'] : base_url('reservas/save') ?>" method="post">
										<?= csrf_field(); ?>
                                        <!--begin::Card body-->
                                        <div class="card-body border-top p-9">   
											...
											<div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label required fw-bold fs-6" for="id_atraccion">Atracción</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
											...
											<div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label required fw-bold fs-6" for="id_usuario">Usuario</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8 fv-row">
												<select class="form-select form-select-lg form-select-solid" name="id_usuario" id="id_usuario" data-control="select2" data-placeholder="Selecciona un usuario">
													<option></option>
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label required fw-bold fs-6" for="fecha">Fecha</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <!--begin::Row-->
											...
											<div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label required fw-bold fs-6" for="id_horario">Horario</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8 fv-row">
												<select class="form-select form-select-lg form-select-solid" name="id_horario" id="id_horario" data-control="select2" data-placeholder="Selecciona un horario">
													<option></option>                                                    
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label required fw-bold fs-6" for="cantidad_personas">Cantidad de Personas</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <!--begin::Row-->
											...
											<div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label required fw-bold fs-6" for="estado">Estado</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8 fv-row">
												<select class="form-select form-select-lg form-select-solid" name="estado" id="estado" data-control="select2" data-placeholder="Selecciona un estado">
													<option></option>
                                        ...
                                        <div class="card-footer d-flex justify-content-end py-6 px-9">
											<a href="<?= base_url('reservas') ?>" class="btn btn-light btn-active-light-primary me-2">Cancelar</a>
											<button type="submit" id="submitBtn" class="btn btn-success"><?= isset($review) ? 'Actualizar' : 'Guardar' ?></button>
                                        </div>
                                        <!--end::Actions-->
                                    </form>
                                    <!--end::Form-->
