				...
				<div class="aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
							...
							<!--Sección de Reseñas-->
							<div class="menu-item">
								<a class="menu-link active" href="<?= base_url("reviews") ?>">
									<span class="menu-icon">
										<!--begin::Svg Icon | path: icons/duotune/art/art002.svg-->
										<span class="svg-icon svg-icon-2">
											<svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
										...
										<div class="menu-item me-lg-1">
											...
											<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack"><!-- migas de pan -->
												...
												<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
													<!--begin::Title-->
													<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Reseñas</h1>
													<!--end::Title-->
													<!--begin::Separator-->
													...
													<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
														...
														<!--end::Item-->
														<!--begin::Item-->
														<li class="breadcrumb-item text-dark"><?= isset($review) ? 'Editar Reseña' : 'Crear Reseña' ?></li>
														<!--end::Item-->
													</ul>
													<!--end::Breadcrumb-->
												</div>
						...
						<div id="kt_content_container" class="container-xxl">
							...
							<div class="card mb-5 mb-xl-10"><!-- PARTE DEL FORMULARIO PARA CREAR Y EDITAR -->
                                ...
                                <div id="kt_account_profile_details" class="collapse show">
									...
									<?php endif; ?>
                                    <!--begin::Form-->
                                    <form id="userForm" action="<?= isset($review) ? base_url('reviews/save/') . $review['id'] : base_url('reviews/save') ?>" method="post">
										<?= csrf_field(); ?>
                                        <!--begin::Card body-->
                                        <div class="card-body border-top p-9">   
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label required fw-bold fs-6" for="calificacion">Calificación</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <!--begin::Row-->
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 fv-row">
                                                            <input type="text" name="calificacion" id="calificacion" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Calificación" value="<?= set_value('calificacion', $review['calificacion'] ?? '') ?>"required/>
                                                        </div>
                                                        <!--end::Col-->                                                        
                                                    </div>
                                                    <!--end::Row-->
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label required fw-bold fs-6" for="comentario">Comentario</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8 fv-row">
                                                    <textarea name="comentario" id="comentario" class="form-control form-control-lg form-control-solid" maxlength="350" placeholder="Comentario" required><?= set_value('comentario', $review['comentario'] ?? '') ?></textarea>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->                                         				
                                        ...
                                        <div class="card-footer d-flex justify-content-end py-6 px-9">
											<a href="<?= base_url('reviews') ?>" class="btn btn-light btn-active-light-primary me-2">Cancelar</a>
