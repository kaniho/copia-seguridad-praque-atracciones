										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-toolbar">
												...
												<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
														...
														<div class="px-7 py-5" data-kt-user-table-filter="form">
															...
															<form method="GET" action="<?= base_url("tickets") ?>">
																...
																<div class="mb-5">
																	...
																	<div class="input-group w-auto">
																		<input type="text" name="codigoTicket" class="form-control" placeholder="Código Ticket" value="<?= esc($codigoTicket) ?>">
																	</div>
																</div>
																<!--end::Input group-->
																<!--begin::Input group-->
																...
																<!--begin::Input group-->
																<div class="mb-5">
																	<label class="form-label fs-6 fw-bold">Fecha Creación:</label>
																	<div class="input-group w-auto">
																...
																<!--begin::Input group-->
																<div class="mb-5">
																	<label class="form-label fs-6 fw-bold">Mostrar Tickets:</label>
																	<div class="input-group w-auto">
																	<select name="ticketArchivado" id="ticketArchivado" class="form-select">
																		<option selected>selecciona una opción</option>
																		<option value="0" <?= $ticketArchivado === '0' ? 'selected' : '' ?>>No Archivados</option>
																		<option value="1" <?= $ticketArchivado === '1' ? 'selected' : '' ?>>Archivados</option>
																		<option value="2" <?= $ticketArchivado === '2' ? 'selected' : '' ?>>Todos</option>
																	</select>
																	</div>
																</div>
																<!--end::Input group-->
																...
																<div class="d-flex justify-content-end">
																	<button type="reset" class="btn btn-light btn-active-light-primary fw-bold me-2 px-6" onclick="window.location.href='<?= base_url("tickets") ?>'">Restablece</button>
																	<button type="submit" class="btn btn-primary">Buscar</button>
																</div>
															</form>
															<!--end::Actions-->
													...
													<!--end::Filter-->
													<!--begin::Export-->
													<form method="GET" action="<?= base_url('tickets/exportExcel') ?>">
														<input type="hidden" name="codigoTicket" value="<?= esc($codigoTicket) ?>">
														<input type="hidden" name="fechaCreacion" value="<?= esc($fechaCreacion) ?>">
														<input type="hidden" name="estado" value="<?= esc($estado) ?>">														
														<input type="hidden" name="ticketArchivado" value="<?= esc($ticketArchivado) ?>">
													...
													<!--end::Export-->
													<!--begin::Add user-->
													<a href="<?= base_url('tickets/save') ?>" class="btn btn-primary ">
														<span class="svg-icon svg-icon-2">
															<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
